...
def find_limiting_magnitude(filter, data, header, aperture_size = 0.1, n_apertures = 100, if_hist = 1):
    ...
    mean_ADU, median_ADU, std_ADU  = sigma_clipped_stats(fluxes_ADU, sigma=3, maxiters=5)

    # find the 1,3, and 5-sigma background flux level
    bkg_ADU_1s = std_ADU
    bkg_ADU_3s = 3 * std_ADU
    bkg_ADU_5s = 5 * std_ADU
