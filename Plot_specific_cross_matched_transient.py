...
def plot(obs, inter = 25, ep = 2):
    ...
    # Open the CSV file
    table = 'C:/Users/andre/MasterCode/Code/cross_matched_transients/all_transformations/'+str(obs[:5])+'.csv'
    ...
    fig.suptitle(f"{obs}", fontsize=22)
...
def save_plot(output_folder, obs, inter = 25, ep = 2):
    names, Data, Header = openfits('C:/Users/andre/MasterCode/Grizli_transient_data/'+str(obs[:5]))
